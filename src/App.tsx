  ...
  fr: {
    ...
    gallery: {
      ...
      items: [
        ...
        { title: 'Compatibilité Kundli', description: 'Image éducative sur la compatibilité.', image: '/gallery-7.jpg' },
  ...
  hi: {
    ...
    gallery: {
      ...
      items: [
        ...
        { title: 'कुंडली मिलान', description: 'अनुकूलता से जुड़ी शैक्षिक छवि।', image: '/gallery-7.jpg' },
